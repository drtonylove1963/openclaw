...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    templates: "Create and manage mission templates.",
    healing: "Self-healing engine monitoring and control.",
    refinement: "Code refinement and optimization cycles.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from pronetheia dashboard --no-open on your desktop.",
    },
    insecure: {
