...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "pronetheia-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as PronetheiaApp);
      void loadAgents(host as unknown as PronetheiaApp);
      void loadToolsCatalog(host as unknown as PronetheiaApp);
      void loadNodes(host as unknown as PronetheiaApp, { quiet: true });
      void loadDevices(host as unknown as PronetheiaApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as PronetheiaApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as PronetheiaApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as PronetheiaApp);
  }
}
