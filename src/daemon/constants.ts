...
export const GATEWAY_LAUNCH_AGENT_LABEL = "ai.pronetheia.gateway";
...
export const NODE_LAUNCH_AGENT_LABEL = "ai.pronetheia.node";
...
export function resolveGatewayLaunchAgentLabel(profile?: string): string {
  ...
  return `ai.pronetheia.${normalized}`;
}
...
export function resolveGatewayServiceDescription(params: {
  ...
  return (
    ...
    formatGatewayServiceDescription({
      profile: params.env.PRONETHEIA_PROFILE,
      version: params.environment?.PRONETHEIA_SERVICE_VERSION ?? params.env.PRONETHEIA_SERVICE_VERSION,
    })
  );
}
