...
export async function finalizeOnboardingWizard(
  ...
  if (!opts.skipUi && gatewayProbe.ok) {
    ...
    await prompter.note(
      [
        ...
        "Stored in: ~/.pronetheia/openclaw.json (gateway.auth.token) or PRONETHEIA_GATEWAY_TOKEN.",
  ...
  await prompter.note(
    [
      ...
      "Docs: https://docs.pronetheia.ai/concepts/agent-workspace",
    ].join("\n"),
    "Workspace backup",
  );

  await prompter.note(
    "Running agents on your computer is risky — harden your setup: https://docs.pronetheia.ai/security",
    "Security",
  );
