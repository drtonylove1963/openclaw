...
const ENTRY_WRAPPER_PAIRS = [
  { wrapperBasename: "pronetheia.mjs", entryBasename: "entry.js" },
  { wrapperBasename: "pronetheia.js", entryBasename: "entry.js" },
...
if (
  ...
  function ensureExperimentalWarningSuppressed(): boolean {
    ...
    if (isTruthyEnvValue(process.env.PRONETHEIA_NO_RESPAWN)) {
      return false;
    }
    if (isTruthyEnvValue(process.env.PRONETHEIA_NODE_OPTIONS_READY)) {
      return false;
    }
    ...
    process.env.PRONETHEIA_NODE_OPTIONS_READY = "1";
