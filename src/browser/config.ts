...
import {
  ...
  DEFAULT_PRONETHEIA_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_PRONETHEIA_BROWSER_COLOR;
  }
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_PRONETHEIA_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_PRONETHEIA_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  const enabled = cfg?.enabled ?? DEFAULT_PRONETHEIA_BROWSER_ENABLED;
