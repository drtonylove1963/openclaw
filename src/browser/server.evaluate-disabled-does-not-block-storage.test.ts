...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.PRONETHEIA_GATEWAY_PORT;
    process.env.PRONETHEIA_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.PRONETHEIA_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.PRONETHEIA_GATEWAY_PASSWORD;
