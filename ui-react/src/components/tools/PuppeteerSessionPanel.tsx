...
interface PuppeteerSessionPanelProps {
  tool: Tool;
  onClose: () => void;
}

export const PuppeteerSessionPanel: React.FC<PuppeteerSessionPanelProps> = ({
  tool,
  onClose,
}) => {
      ...
      <div style={styles.panel} onClick={e => e.stopPropagation()}>
        <div style={styles.header}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <h2 style={styles.title}>Puppeteer Session</h2>
            {session && (
                  ...
                  <div style={styles.resultsList}>
                    {results.slice().toReversed().map((result, idx) => (
                      <div key={idx} style={styles.resultItem}>
                        ...
                        ) : result.result?.data?.startsWith?.('Screenshot') ? (
                          <>
...
export default PuppeteerSessionPanel;
